...
class _HomePageState extends State<HomePage> {
  ...
  // This creates a consistent game ID for any two players.
  String _createDeterministicGameId(String userId1, String userId2) {
    // Sort the IDs alphabetically to ensure the same game ID is generated
    // regardless of who is user1 or user2.
